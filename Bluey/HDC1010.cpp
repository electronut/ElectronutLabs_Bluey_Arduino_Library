...
/**
 * Reads num bytes starting from address register on device in to _buff array specific to HDC1010 sensor
 */
static uint16_t HDC1010_readData(uint8_t dev_addr, uint8_t reg_addr, uint8_t num_bytes)
{
  uint8_t msb, lsb;
